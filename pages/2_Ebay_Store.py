...
def _build_active_inventory_pricing_df(
    ...
    for _, item in working.iterrows():
        ...
        if market_value > 0:
            ...
            market_est_net = None
            market_est_ebay_fees = None
            market_est_label = None
            market_shipping_option = ""
            market_value_over_10pct_price = None
        ...
        if market_value <= 0:
            market_opportunity_tier = "No market value"
        elif market_est_profit_loss is None or market_est_margin_pct is None:
            market_opportunity_tier = "Missing cost"
        elif market_est_profit_loss < 0:
            market_opportunity_tier = "Loss at market"
        elif market_est_margin_pct < 10:
